...
export const creators = pgTable('creators', {
  ...
  youtubeSubscriberCount: integer('youtube_subscriber_count'),
  youtubeChannelVerifiedAt: timestamp('youtube_channel_verified_at'),
...
export const ugcSubmissions = pgTable('ugc_submissions', {
  ...
  autoFetchedLikes: integer('auto_fetched_likes'),
  autoFetchedComments: integer('auto_fetched_comments'),
